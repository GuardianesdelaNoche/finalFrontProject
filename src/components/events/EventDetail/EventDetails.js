					...
					<div class="card card-flush pt-12">
						<div class="card-header">
							...
							<div class="d-flex flex-column flex-grow-1">
								...
								<span class="text-description d-block mt-1">Nickname Users</span>
							</div>
						...
						<div class="card-body">
							...
							{/* Event Title */}
							<h2 class="text-dark fw-bolder pt-5 mb-10">{title} </h2>


							{/* Event Description */}
							<p class="text-description fs-6 fw-normal pt-2 mb-2"> {description}</p>
